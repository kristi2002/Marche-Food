...
.allergeni-section { border-top:1px solid var(--border); }
.section-title { font-size:0.95rem; font-weight:700; color:var(--pine-strong); margin:0 0 1rem 0; }
.hint { color:var(--ink-2); font-size:0.75rem; }
